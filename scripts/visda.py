...
def vis_doppler_azimuth(frame, flow_model=None, pub_flow=None):
...
def main(args=None):
    ...
    node = rclpy.create_node('da_visualizer')
    # Flow model.
    # if args.saved_model_path:
    #     core = ov.Core()
    ...
    subscriber_radar = node.create_subscription(RadarFrameFull,'radar_data',lambda frame: vis_doppler_azimuth(frame),1)
